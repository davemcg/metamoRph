...
Let's try `stats::prcomp` again with the same new_data, just scaled up 10x.

Well ugh, look, now the new cornea samples look like the RPE!!!!!
```{r, fig.width=4, fig.height=3}
with_predict <- predict(faux_pca, (log1p(new_data*10)))
